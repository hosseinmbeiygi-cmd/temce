...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("isin", sa.String(20), nullable=True, unique=True,
                  comment="کد ISIN (شناسه بین‌المللی)"),
        sa.Column("fund_type", sa.String(30), nullable=True, index=True,
        ...
        sa.Column("nav_change", sa.Float(), nullable=True,
                  comment="تغییر NAV نسبت به روز قبل"),
        sa.Column("nav_change_pct", sa.Float(), nullable=True,
        ...
        sa.Column("snapshot_date", sa.String(10), nullable=True, index=True,
                  comment="تاریخ اسنپ‌شات (YYYY-MM-DD)"),
        sa.Column("extra", sa.Text(), nullable=True,
                  comment="داده‌های اضافی (JSON)"),
