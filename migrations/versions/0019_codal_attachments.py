...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("storage_type", sa.String(20), nullable=False, server_default="local", comment="local | s3 | database"),
        sa.Column("storage_path", sa.String(500), nullable=True),
        sa.Column("file_size", sa.BigInteger(), nullable=True),
        sa.Column("mime_type", sa.String(100), nullable=True),
        sa.Column("status", sa.String(20), nullable=False, server_default="pending", comment="pending | downloading | done | error"),
