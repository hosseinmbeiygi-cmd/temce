...
class OptionsStrategyEngine:
    ...
    def analyze_collar(
        self, stock_price: float, put_strike: float, put_premium: float,
        call_strike: float, call_premium: float, shares: int = 1000
    ) -> StrategyResult:
    ...
    def analyze_long_strangle(
        self, stock_price: float, call_strike: float, put_strike: float,
    ...
    def analyze_bull_call_spread(
        self, stock_price: float, lower_strike: float, upper_strike: float,
        ...
        return StrategyResult(
            ...
            example={"symbol": "فملی", "lower_strike": 250, "upper_strike": 400, "lower_premium": 20, "upper_premium": 50},
        )
    ...
    def analyze_bull_put_spread(
        self, stock_price: float, higher_strike: float, lower_strike: float,
        higher_premium: float, lower_premium: float
    ) -> StrategyResult:
    ...
    def analyze_long_call_butterfly(
        self, stock_price: float, low_strike: float, mid_strike: float,
        high_strike: float, low_premium: float, mid_premium: float, high_premium: float
    ) -> StrategyResult:
    ...
    def analyze_iron_butterfly(
        self, stock_price: float, center_strike: float,
        outer_call_strike: float, outer_put_strike: float,
        center_call_premium: float, center_put_premium: float,
        outer_call_premium: float, outer_put_premium: float
    ) -> StrategyResult:
        ...
        return StrategyResult(
            ...
            legs=[
                {"type": "call", "side": "sell", "strike": center_strike, "premium": center_call_premium, "quantity": 1},
                {"type": "put", "side": "sell", "strike": center_strike, "premium": center_put_premium, "quantity": 1},
                {"type": "call", "side": "buy", "strike": outer_call_strike, "premium": outer_call_premium, "quantity": 1},
    ...
    def analyze_iron_condor(
        ...
        put_high_strike: float, put_low_strike: float,
        call_low_strike: float, call_high_strike: float,
        put_high_premium: float, put_low_premium: float,
        call_low_premium: float, call_high_premium: float
    ) -> StrategyResult:
        """Iron Condor: Bull put spread + bear call spread."""
        net_credit = put_high_premium - put_low_premium + call_low_premium - call_high_premium
        max_profit = net_credit
        max_loss = max(
            put_high_strike - put_low_strike,
            call_high_strike - call_low_strike
        ) - net_credit
        return StrategyResult(
            ...
            legs=[
                ...
                {"type": "call", "side": "buy", "strike": call_high_strike, "premium": call_high_premium, "quantity": 1},
            ],
            max_profit=max_profit,
            max_loss=-max_loss,
    ...
    def analyze_long_call_condor(
        self, stock_price: float, k1: float, k2: float, k3: float, k4: float,
    ...
    def analyze_strip(
        self, stock_price: float, strike: float,
        call_premium: float, put_premium: float
    ) -> StrategyResult:
    ...
    def analyze_calendar_spread(
        ...
        return StrategyResult(
            ...
            legs=[
                {"type": option_type, "side": "sell", "strike": strike, "premium": near_premium, "quantity": 1, "expiry": "near"},
                {"type": option_type, "side": "buy", "strike": strike, "premium": far_premium, "quantity": 1, "expiry": "far"},
            ],
            max_profit=float("inf"),
            max_loss=-net_cost,
            break_even=[],
    ...
    def analyze_ratio_spread(
        self, stock_price: float, buy_strike: float, sell_strike: float,
        buy_premium: float, sell_premium: float, sell_qty: int = 2,
        ...
        return StrategyResult(
            ...
            legs=[
                ...
                {"type": option_type, "side": "sell", "strike": sell_strike, "premium": sell_premium, "quantity": sell_qty},
            ],
    ...
    def analyze_call_back_spread(
        self, stock_price: float, itm_strike: float, otm_strike: float,
        itm_premium: float, otm_premium: float
    ) -> StrategyResult:
    ...
    def analyze_diagonal_call_spread(
        self, stock_price: float,
        long_call_strike: float, short_call_strike: float,
        long_call_premium: float, short_call_premium: float,
        long_call_expiry: str = "6m", short_call_expiry: str = "1m"
    ) -> StrategyResult:
        ...
        return StrategyResult(
            ...
            legs=[
                {"type": "call", "side": "buy", "strike": long_call_strike, "premium": long_call_premium,
                 "quantity": 1, "expiry": long_call_expiry},
                {"type": "call", "side": "sell", "strike": short_call_strike, "premium": short_call_premium,
                 "quantity": 1, "expiry": short_call_expiry},
            ],
            max_profit=float("inf"),
            max_loss=-net_cost,
            break_even=[],
    ...
    def analyze_diagonal_put_spread(
        self, stock_price: float,
        long_put_strike: float, short_put_strike: float,
        long_put_premium: float, short_put_premium: float,
        long_put_expiry: str = "6m", short_put_expiry: str = "1m"
    ) -> StrategyResult:
        ...
        return StrategyResult(
            ...
            legs=[
                {"type": "put", "side": "buy", "strike": long_put_strike, "premium": long_put_premium,
                 "quantity": 1, "expiry": long_put_expiry},
                {"type": "put", "side": "sell", "strike": short_put_strike, "premium": short_put_premium,
                 "quantity": 1, "expiry": short_put_expiry},
            ],
            max_profit=float("inf"),
            max_loss=-net_cost,
            break_even=[],
    ...
    def calculate_position_size(
        self, capital: float, risk_per_trade_pct: float,
        max_loss_per_contract: float, option_type: str = "buy"
    ) -> dict[str, Any]:
    ...
    def calculate_iv_rank(
        self, current_iv: float, iv_52w_high: float, iv_52w_low: float
    ) -> dict[str, Any]:
    ...
    def analyze_options_chain(
        ...
        call_oi_strikes = sorted(
            [(o.get("strike", 0), o.get("open_interest", 0)) for o in calls],
            key=lambda x: x[1], reverse=True
        )
        put_oi_strikes = sorted(
            [(o.get("strike", 0), o.get("open_interest", 0)) for o in puts],
            key=lambda x: x[1], reverse=True
        )
    ...
    def generate_trade_checklist(
        self, strategy: str, stock_price: float, strike: float
    ) -> list[dict[str, Any]]:
        ...
        if strategy in ("short_straddle", "short_strangle", "iron_butterfly", "iron_condor"):
            ...
            checklist.append({"item": "وجه تضمین اضافی برای مدیریت ریسک کنار گذاشته شده", "done": False, "priority": "high"})
        ...
        if strategy in ("long_straddle", "long_strangle", "long_gut"):
            checklist.append({"item": "رویداد محرک (اخبار، مجمع) در آینده نزدیک وجود دارد", "done": False, "priority": "medium"})

        # Price proximity check
        pct_from_strike = abs(stock_price - strike) / stock_price * 100
        if pct_from_strike > 20:
            checklist.append({"item": f"فاصله قیمت سهم تا اعمال: {pct_from_strike:.1f}% - بررسی کنید", "done": False, "priority": "medium"})
    ...
    def get_all_strategies(self) -> list[dict[str, Any]]:
        ...
        return [
            {"id": "covered_call", "name": "Covered Call", "name_fa": "کاورد کال", "category": "income", "market": "neutral_bullish", "risk": "medium", "legs": 2},
            {"id": "married_put", "name": "Married Put", "name_fa": "مرید پوت", "category": "protection", "market": "bullish", "risk": "low", "legs": 2},
            {"id": "collar", "name": "Collar", "name_fa": "کولار", "category": "protection", "market": "neutral", "risk": "low", "legs": 3},
            {"id": "long_straddle", "name": "Long Straddle", "name_fa": "استرادل خرید", "category": "volatility", "market": "volatile", "risk": "high", "legs": 2},
            {"id": "short_straddle", "name": "Short Straddle", "name_fa": "استرادل فروش", "category": "income", "market": "neutral_low_vol", "risk": "very_high", "legs": 2},
            {"id": "long_strangle", "name": "Long Strangle", "name_fa": "استرانگل خرید", "category": "volatility", "market": "volatile", "risk": "high", "legs": 2},
            {"id": "short_strangle", "name": "Short Strangle", "name_fa": "استرانگل فروش", "category": "income", "market": "neutral_low_vol", "risk": "high", "legs": 2},
            {"id": "bull_call_spread", "name": "Bull Call Spread", "name_fa": "بول کال اسپرد", "category": "directional", "market": "bullish_mild", "risk": "medium", "legs": 2},
            {"id": "bear_call_spread", "name": "Bear Call Spread", "name_fa": "بیر کال اسپرد", "category": "directional", "market": "bearish_mild", "risk": "medium", "legs": 2},
            {"id": "bull_put_spread", "name": "Bull Put Spread", "name_fa": "بول پوت اسپرد", "category": "directional", "market": "bullish_mild", "risk": "medium", "legs": 2},
            {"id": "bear_put_spread", "name": "Bear Put Spread", "name_fa": "بیر پوت اسپرد", "category": "directional", "market": "bearish_mild", "risk": "medium", "legs": 2},
            {"id": "long_call_butterfly", "name": "Long Call Butterfly", "name_fa": "پروانه اختیار خرید", "category": "neutral", "market": "neutral", "risk": "low", "legs": 3},
            {"id": "short_call_butterfly", "name": "Short Call Butterfly", "name_fa": "پروانه فروش اختیار خرید", "category": "volatility", "market": "volatile", "risk": "medium", "legs": 3},
            {"id": "long_put_butterfly", "name": "Long Put Butterfly", "name_fa": "پروانه اختیار فروش", "category": "neutral", "market": "neutral", "risk": "low", "legs": 3},
            {"id": "short_put_butterfly", "name": "Short Put Butterfly", "name_fa": "پروانه فروش اختیار فروش", "category": "volatility", "market": "volatile", "risk": "medium", "legs": 3},
            {"id": "iron_butterfly", "name": "Iron Butterfly", "name_fa": "پروانه آهنی", "category": "income", "market": "neutral_low_vol", "risk": "high", "legs": 4},
            {"id": "iron_condor", "name": "Iron Condor", "name_fa": "کرکس آهنی", "category": "income", "market": "neutral", "risk": "medium", "legs": 4},
            {"id": "long_call_condor", "name": "Long Call Condor", "name_fa": "کندر خرید با اختیار خرید", "category": "neutral", "market": "neutral", "risk": "low", "legs": 4},
            {"id": "strip", "name": "Strip", "name_fa": "استریپ", "category": "volatility", "market": "volatile_bearish", "risk": "high", "legs": 3},
            {"id": "strap", "name": "Strap", "name_fa": "استرپ", "category": "volatility", "market": "volatile_bullish", "risk": "high", "legs": 3},
            {"id": "long_gut", "name": "Long Gut", "name_fa": "گات خرید", "category": "volatility", "market": "volatile", "risk": "high", "legs": 2},
            {"id": "calendar_spread", "name": "Calendar Spread", "name_fa": "اسپرد تقویمی", "category": "time", "market": "neutral", "risk": "medium", "legs": 2},
            {"id": "ratio_spread", "name": "Ratio Spread", "name_fa": "اسپرد نسبتی", "category": "directional", "market": "directional", "risk": "high", "legs": 2},
            {"id": "call_back_spread", "name": "Call Back Spread", "name_fa": "اسپرد بازگشتی اختیار خرید", "category": "volatility", "market": "volatile_bullish", "risk": "high", "legs": 2},
            {"id": "put_back_spread", "name": "Put Back Spread", "name_fa": "اسپرد بازگشتی اختیار فروش", "category": "volatility", "market": "volatile_bearish", "risk": "high", "legs": 2},
            {"id": "conversion", "name": "Conversion", "name_fa": "کانورژن", "category": "arbitrage", "market": "any", "risk": "low", "legs": 2},
            {"id": "synthetic_long", "name": "Synthetic Long", "name_fa": "سهام مصنوعی صعودی", "category": "directional", "market": "bullish", "risk": "medium", "legs": 2},
            {"id": "synthetic_short", "name": "Synthetic Short", "name_fa": "سهام مصنوعی نزولی", "category": "directional", "market": "bearish", "risk": "high", "legs": 2},
            {"id": "diagonal_call_spread", "name": "Diagonal Call Spread", "name_fa": "اسپرد مورب اختیار خرید", "category": "time", "market": "bullish_mild", "risk": "medium", "legs": 2},
            {"id": "diagonal_put_spread", "name": "Diagonal Put Spread", "name_fa": "اسپرد مورب اختیار فروش", "category": "time", "market": "bearish_mild", "risk": "medium", "legs": 2},
        ]

    def recommend(
        self, market_condition: str, risk_tolerance: float = 0.5
    ) -> list[dict[str, Any]]:
