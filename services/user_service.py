...
class UserService:
    ...
    async def disable_mfa(self, user_id: str, password: str, code: str, *, send_new_code: bool = False) -> Result[dict[str, Any]]:
    ...
    async def mfa_status(self, user_id: str) -> Result[dict[str, Any]]:
        ...
        try:
            ...
            return Result.ok({
                ...
                "pending": bool(user.totp_secret and not user.totp_enabled) or bool(
