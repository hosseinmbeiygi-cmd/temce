...
class HistoricalLevelAnalyzer:
    ...
    async def analyze_symbol(self, symbol: str) -> HistoricalLevelResult | None:
        ...
        support_dist = ((current_price - nearest_support) / current_price * 100) if nearest_support > 0 and current_price > 0 else 0
        resistance_dist = ((nearest_resistance - current_price) / current_price * 100) if nearest_resistance > 0 and current_price > 0 else 0
