...
class NewsAnalyzer:
    ...
    POSITIVE_WORDS: set[str] = {
        "افزایش", "رشد", "سود", "خرید", "توافق", "مثبت", "بهبود",
        "صعود", "جهش", "توسعه", "گسترش", "پیشرفت", "موفقیت",
        "سبز", "بالا", "قوی", "عالی", "خوب", "مناسب",
        "سودده", "سودآور", "بازده", "بهبودی", "رونق", "انعقاد",
        "امضا", "قرارداد", "همکاری", "افزایشی", "بهینه",
    }

    # Negative sentiment words
    NEGATIVE_WORDS: set[str] = {
        "کاهش", "افت", "ضرر", "فروش", "تحریم", "منفی", "ریزش",
        "نگرانی", "بحران", "مشکل", "اخطار", "هشدار", "زیان",
        "نزول", "سقوط", "ضعیف", "بد", "نامناسب", "پایین",
        "قرمز", "کمبود", "محدودیت", "فشار", "توقف", "تعلیق",
        "ورشکستگی", "تعدیل", "بدهی", "زیانده",
        "اخلال", "تنش", "تحریمی", "کاهشی", "نگران کننده",
    }
    ...
    def _generate_summary(
        cls, news_list: list[dict], events: list[str], sentiment: str
    ) -> str:
