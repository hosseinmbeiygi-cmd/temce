...
class CompoundSplitter:
    ...
    CONNECTORS = [
        r"\s+و\s+", r"\s+و\s+هم\s+", r"\s+و\s+نیز\s+",
        r"\s+و\s+بعد\s+", r"\s+سپس\s+", r"\s+بعدش\s+",
        r"\s+همچنین\s+", r"\s+علاوه بر\s+",
        r"\s+and\s+", r"\s+then\s+", r"\s+also\s+",
        r"\s*,+\s*و\s*", r"\s*[،,]\s*",
    ]
    ...
    def _count_potential_intents(cls, text: str) -> int:
        ...
        intent_keywords = {
            "تحلیل": 1, "بررسی": 1, "وضعیت": 1,
            "قیمت": 1, "نمودار": 1, "اخبار": 1,
            "مقایسه": 1, "بهترین": 1, "بازار": 1,
            "فیلتر": 1, "غربال": 1,
            "پیش‌بینی": 1, "سیگنال": 1,
            "اضافه": 1, "حذف": 1, "دیده‌بان": 1,
            "هشدار": 1, "پرتفوی": 1, "سبد": 1,
            "بک‌تست": 1, "آموزش": 1,
            "طلا": 1, "دلار": 1, "سکه": 1,
            "گزارش": 1, "نقشه": 1,
        }
