...
class BalanceSheetValidator:
    def validate(self, data: dict[str, float]) -> ValidationResult:
        ...
        total_equity = data.get("total_equity") or data.get("TOTAL_EQUITY") or data.get("equity") or data.get("EQUITY") or 0
...
class DataValidationPipeline:
    ...
    def reconcile(self, data: dict[str, float]) -> dict[str, float]:
        ...
        total_equity = reconciled.get("total_equity") or reconciled.get("TOTAL_EQUITY") or reconciled.get("equity") or reconciled.get("EQUITY") or 0
