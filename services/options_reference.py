...
STRATEGY_SELECTION_GUIDE: list[dict[str, Any]] = [
    {
        ...
        "answers": [
            ...
            {"condition": "خنثی (رنج)", "strategies": ["short_straddle", "iron_condor", "butterfly", "covered_call"], "risk": "medium"},
            {"condition": "پرنوسان (جهت نامشخص)", "strategies": ["long_straddle", "long_strangle", "reverse_iron_butterfly"], "risk": "high"},
        ],
    },
    {
        "question": "میزان تحمل ریسک شما چقدر است؟",
        "answers": [
            {"condition": "ریسک‌پذیر", "strategies": ["short_straddle", "short_strangle", "ratio_spread"], "description": "سود و زیان نامحدود"},
            {"condition": "ریسک‌پذیر متوسط", "strategies": ["long_call", "long_put", "straddle"], "description": "سود نامحدود و زیان محدود"},
            {"condition": "ریسک‌گریز", "strategies": ["bull_call_spread", "bear_put_spread", "butterfly", "iron_condor"], "description": "سود و زیان محدود"},
        ],
    },
    {
        "question": "افق زمانی شما چقدر است؟",
        "answers": [
            {"condition": "کوتاه‌مدت (چند روز تا چند هفته)", "strategies": ["straddle", "strangle", "short_straddle"], "description": "استراتژی‌های نوسانی و فروش پریمیوم"},
            {"condition": "میان‌مدت (چند هفته تا چند ماه)", "strategies": ["spread", "covered_call", "collar"], "description": "اسپردها و پوشش ریسک"},
            {"condition": "بلندمدت (بیش از ۶ ماه)", "strategies": ["married_put", "long_call", "long_put"], "description": "خرید اختیار با سررسید بلند"},
        ],
    },
]
