...
class MetaStrategy:
    ...
    def __init__(self) -> None:
        ...
        self._regime_fitness: dict[str, dict[str, float]] = {
            "momentum": {"trend": 0.9, "normal": 0.5, "mean_reverting": 0.1, "panic": 0.2, "low_liquidity": 0.3, "queue_lock": 0.3},
            "mean_reversion": {"mean_reverting": 0.9, "normal": 0.5, "trend": 0.1, "panic": 0.3, "low_liquidity": 0.4, "queue_lock": 0.4},
            "arbitrage": {"normal": 0.6, "trend": 0.4, "mean_reverting": 0.4, "panic": 0.1, "low_liquidity": 0.1, "queue_lock": 0.1},
            "market_making": {"normal": 0.7, "low_liquidity": 0.8, "queue_lock": 0.6, "trend": 0.3, "panic": 0.2, "mean_reverting": 0.5},
            "defensive": {"panic": 0.9, "low_liquidity": 0.7, "queue_lock": 0.6, "normal": 0.2, "trend": 0.1, "mean_reverting": 0.2},
        }
