...
### تست اتصال
```bash
curl -s "https://Api.BrsApi.ir/Market/Commodity.php?key=Bk7JvdJZBHJ9DMhzeuTfWjwqYy1wMsif" | python -m json.tool
```

### دریافت کامودیتی‌ها
```bash
curl -s "https://Api.BrsApi.ir/Market/Commodity.php?key=Bk7JvdJZBHJ9DMhzeuTfWjwqYy1wMsif" > commodity.json
```

### دریافت ارزهای دیجیتال
```bash
curl -s "https://Api.BrsApi.ir/Market/Cryptocurrency.php?key=Bk7JvdJZBHJ9DMhzeuTfWjwqYy1wMsif" > crypto.json
```

### دریافت طلا و سکه
```bash
curl -s "https://Api.BrsApi.ir/Market/Coin.php?key=Bk7JvdJZBHJ9DMhzeuTfWjwqYy1wMsif" > gold.json
```

### دریافت نرخ ارز
```bash
curl -s "https://Api.BrsApi.ir/Market/Currency.php?key=Bk7JvdJZBHJ9DMhzeuTfWjwqYy1wMsif" > currency.json
```
...
```
BRSAPI_API_KEY=Bk7JvdJZBHJ9DMhzeuTfWjwqYy1wMsif
```

### ۳. بررسی پاسخ API
```bash
curl -v "https://Api.BrsApi.ir/Market/Commodity.php?key=Bk7JvdJZBHJ9DMhzeuTfWjwqYy1wMsif"
```
