...
@router.post("/{instrument_id}/{name}", summary="Create indicator", description="Create a technical indicator for an instrument")
...
@router.get("/{instrument_id}/{name}", summary="Get indicator", description="Get a technical indicator value for an instrument")
