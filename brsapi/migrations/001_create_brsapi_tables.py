...
def _create_gold_coin_prices() -> None:
    op.create_table(
        ...
        sa.Column("change_value", sa.Float(), nullable=True),
        sa.Column("change_percent", sa.Float(), nullable=True),
        sa.Column("unit", sa.String(20), nullable=True, server_default="IRR"),
        sa.Column("date", sa.String(20), nullable=True),
        sa.Column("time", sa.String(20), nullable=True),
        sa.Column("time_unix", sa.BigInteger(), nullable=True),
        sa.Column("fetched_at", sa.String(30), nullable=True),
    ...
    op.create_index("idx_gold_symbol_fetched", "brsapi_gold_coin_prices", ["symbol", "fetched_at"])
...
def _create_currency_prices() -> None:
    op.create_table(
    ...
    op.create_index("idx_currency_symbol_fetched", "brsapi_currency_prices", ["symbol", "fetched_at"])
...
def upgrade() -> None:
    ...
    _create_gold_coin_prices()
    _create_gold_coin_history()
    _create_currency_prices()
