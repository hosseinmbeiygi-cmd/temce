...
export default function FundDetailPage() {
  ...
  const localAnalysis = useMemo(() => (detail ? analyzeFund(detail) : null), [detail]);
      ...
      {!isLoading && detail?.found !== false && detail && (
        <>
          ...
          <div className="mt-5">
            <FundScorecardPanel
              fund={detail}
              scores={analysis?.scores ?? localAnalysis?.scores ?? { financial: 0, liquidity: 0, management: 0, risk: 0, cost: 0, transparency: 0, total: 0 }}
