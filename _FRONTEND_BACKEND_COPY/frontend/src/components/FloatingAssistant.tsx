        ...
        >
          ...
          {!isMinimized && (
            <>
              ...
              {/* ── Prompt Chips (پرامپت: پرسش‌های سریع صندوق) ── */}
              <div className="shrink-0 px-3 pt-2 flex flex-wrap gap-1.5">
                {[
                  "چرا پایش حباب طلا هشدار داده؟",
                  "بهترین صندوق اهرمی امروز کدام است؟",
                  "صندوق طلا چطوره؟",
                  "مانیتور حباب",
                ].map((chip) => (
                  <button
                    ...
                    disabled={assistantMutation.isPending}
                    className="text-[9px] px-2 py-1 rounded-full bg-primary-600/10 text-primary-300 border border-primary-600/20 hover:bg-primary-600/20 transition-colors disabled:opacity-50"
                  >
                    {chip}
                  </button>
                ))}
