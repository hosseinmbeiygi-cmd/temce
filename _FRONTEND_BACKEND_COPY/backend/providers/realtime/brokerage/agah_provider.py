...
from providers.realtime.brokerage.agah_client import AgahClient
from providers.realtime.brokerage.base import BaseBrokerageProvider

logger = get_logger(__name__)


class AgahProvider(BaseBrokerageProvider):
    def __init__(self, api_key: str = "") -> None:
        super().__init__(name="agah", base_url="")
        self.client = AgahClient(api_key=api_key)
