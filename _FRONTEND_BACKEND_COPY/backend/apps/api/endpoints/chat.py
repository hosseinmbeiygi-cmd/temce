...
@router.post(
    "",
    summary="AI Chatbot (20-Level Engine)",
...
@router.post(
    "/feedback", summary="Submit feedback on chat response", description="Help the system learn from user feedback"
)
...
@router.get(
    "/stats", summary="Chat engine learning statistics", description="View learning statistics for the chat system"
)
