...
def upgrade() -> None:
    ...
    op.create_index("idx_feat_symbol_date_desc", "ml_engineered_features", ["symbol", sa.text("trade_date DESC")])
    op.create_index("idx_feat_calculated_at", "ml_engineered_features", ["calculated_at"])
    op.create_index("idx_feat_target", "ml_engineered_features", ["target_direction_5d", "trade_date"])
    ...
    op.create_index("idx_screener_date_rank", "screener_daily_scores", ["trade_date", "rank_in_market"])
