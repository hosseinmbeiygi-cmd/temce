...
class OpenInterestHistoryModel(Base):
    ...
    __table_args__ = (UniqueConstraint("contract_id", "date", name="uq_oi_contract_date"),)
...
class VolatilitySurfaceModel(Base):
    ...
    __table_args__ = (UniqueConstraint("underlying_symbol", "date", "strike", "expiry_date", name="uq_surface_point"),)
