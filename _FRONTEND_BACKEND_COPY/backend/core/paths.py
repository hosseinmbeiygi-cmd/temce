...
def safe_resolve(base: Path | str, user_path: str) -> Path:
    ...
    try:
        ...
        raise ValueError(f"Path traversal detected: '{user_path}' resolves outside '{base_resolved}'")
    return full
...
def safe_ensure_dir(base: Path | str, subdir: str = "") -> Path:
    ...
    if subdir:
        ...
        try:
            ...
            raise ValueError(f"Path traversal detected: '{subdir}' resolves outside '{base_resolved}'")
    else:
