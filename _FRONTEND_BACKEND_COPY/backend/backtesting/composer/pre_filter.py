...
class PreTestFilter:
    ...
    def should_test(self, blueprint: StrategyBlueprint) -> tuple[bool, str]:
        ...
        if (
            blueprint.entry_indicator == blueprint.exit_indicator
            and blueprint.entry_condition == blueprint.exit_condition
        ):
        ...
        pair = (
            blueprint.entry_indicator,
            blueprint.entry_condition,
            blueprint.exit_indicator,
            blueprint.exit_condition,
        )
