...
class PurgedWalkForward:
    ...
    def get_train_data(self, data: list[dict[str, Any]], window: PurgedWindow) -> list[dict[str, Any]]:
        """Extract training data for a window (purged)."""
        return data[window.train_start : window.train_end]

    def get_test_data(self, data: list[dict[str, Any]], window: PurgedWindow) -> list[dict[str, Any]]:
