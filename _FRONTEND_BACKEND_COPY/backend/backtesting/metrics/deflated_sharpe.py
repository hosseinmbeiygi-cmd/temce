...
def deflated_sharpe_ratio(
    ...
    e_max = math.sqrt(2 * math.log(n_trials)) - (math.log(math.pi) + math.log(math.log(n_trials))) / (
    ...
    sr_se = math.sqrt(
        (1 + 0.5 * sharpe_observed**2 - skewness * sharpe_observed + (kurtosis - 3) / 4 * sharpe_observed**2)
