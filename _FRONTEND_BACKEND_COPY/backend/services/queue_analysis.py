...
def apply_hard_rules(
    ...
    if queue.queue_status == QueueStatus.BUY_QUEUE and queue.queue_days_streak < 3 and queue.queue_volume_ratio > 0.7:
        return "BUY", (
    ...
    # قانون 2: صف فروش
    if queue.queue_status == QueueStatus.SELL_QUEUE and queue.queue_days_streak > 1:
        return "REJECT", (f"Hard Rule: SELL_QUEUE با تداوم {queue.queue_days_streak} روز — override به REJECT")
