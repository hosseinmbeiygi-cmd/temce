...
class NewsIntegration:
    ...
    async def get_news_for_symbols(self, symbols: list[str], days_back: int = 3) -> dict[str, dict[str, Any]]:
    ...
    async def format_news_response(self, symbol: str, analysis: dict[str, Any] | None = None) -> str:
