...
CONTROL_CYCLES = {
    "revenue_cycle": {
        ...
        "controls": [
            {
                "code": "RC1",
                "description": "اعتبار مشتری قبل از ثبت سفارش بررسی می‌شود",
                "control_type": "preventive",
                "frequency": "daily",
            },
            {
                "code": "RC2",
                "description": "سفارشات با قیمت‌نامه مصوب تطبیق داده می‌شود",
                "control_type": "preventive",
                "frequency": "daily",
            },
            {
                "code": "RC3",
                "description": "فاکتورها با اسناد حمل تطبیق داده می‌شود",
                "control_type": "detective",
                "frequency": "daily",
            },
            {
                "code": "RC4",
                "description": "حذف یا تعدیل فاکتور نیاز به تأیید مدیریت دارد",
                "control_type": "preventive",
                "frequency": "weekly",
            },
            {
                "code": "RC5",
                "description": "صورت‌های حساب مشتریان به صورت دوره‌ای ارسال می‌شود",
                "control_type": "detective",
                "frequency": "monthly",
            },
        ],
    ...
    "procurement_cycle": {
        ...
        "controls": [
            {
                "code": "PC1",
                "description": "خرید بالای سقف نیاز به سه پیش فاکتور دارد",
                "control_type": "preventive",
                "frequency": "daily",
            },
            {
                "code": "PC2",
                "description": "کالاهای خریداری شده با سفارش خرید تطبیق داده می‌شود",
                "control_type": "detective",
                "frequency": "daily",
            },
            {
                "code": "PC3",
                "description": "فاکتور تأمین‌کننده قبل از پرداخت تأیید می‌شود",
                "control_type": "preventive",
                "frequency": "daily",
            },
            {
                "code": "PC4",
                "description": "دسته‌های چک بانک به امضای مشترک می‌رسد",
                "control_type": "preventive",
                "frequency": "weekly",
            },
            {
                "code": "PC5",
                "description": "ثبت خرید و پرداخت به صورت ماهانه بایگانی می‌شود",
                "control_type": "detective",
                "frequency": "monthly",
            },
        ],
    ...
    "payroll_cycle": {
        ...
        "controls": [
            {
                "code": "PR1",
                "description": "لیست حقوق با حضور و غیاب تطبیق داده می‌شود",
                "control_type": "detective",
                "frequency": "monthly",
            },
            {
                "code": "PR2",
                "description": "اضافه‌کار با تأیید سرپرست ثبت می‌شود",
                "control_type": "preventive",
                "frequency": "daily",
            },
            {
                "code": "PR3",
                "description": "کسر و اضافات حقوق با مدارک پشتیبان ثبت می‌شود",
                "control_type": "preventive",
                "frequency": "monthly",
            },
            {
                "code": "PR4",
                "description": "ورم‌های حقوق ماهانه توسط مدیر مالی تأیید می‌شود",
                "control_type": "preventive",
                "frequency": "monthly",
            },
        ],
    ...
    "treasury_cycle": {
        ...
        "controls": [
            {
                "code": "TC1",
                "description": "انتقال وجه بین حساب‌ها نیاز به تأیید دو نفره دارد",
                "control_type": "preventive",
                "frequency": "daily",
            },
            {
                "code": "TC2",
                "description": "صورت‌های بانکی به صورت ماهانه تطبیق داده می‌شود",
                "control_type": "detective",
                "frequency": "monthly",
            },
            {
                "code": "TC3",
                "description": "تنخواه گردان‌ها به صورت دوره‌ای تسویه می‌شود",
                "control_type": "detective",
                "frequency": "monthly",
            },
            {
                "code": "TC4",
                "description": "سرمایه‌گذاری‌های کوتاه مدت با مصوبه هیئت مدیره انجام می‌شود",
                "control_type": "preventive",
                "frequency": "daily",
            },
        ],
    ...
    "financial_reporting": {
        ...
        "controls": [
            {
                "code": "FR1",
                "description": "تراز آزمایشی قبل از تهیه صورت‌های مالی بسته می‌شود",
                "control_type": "detective",
                "frequency": "monthly",
            },
            {
                "code": "FR2",
                "description": "ثبت‌های اصلاحی با مستندات پشتیبان تهیه می‌شود",
                "control_type": "preventive",
                "frequency": "monthly",
            },
            {
                "code": "FR3",
                "description": "صورت‌های مالی قبل از انتشار توسط حسابرس داخلی بررسی می‌شود",
                "control_type": "detective",
                "frequency": "quarterly",
            },
            {
                "code": "FR4",
                "description": "تغییرات در رویه‌های حسابداری مستند و افشا می‌شود",
                "control_type": "detective",
                "frequency": "annual",
            },
        ],
...
ACCOUNT_AUDIT_PROGRAMS: dict[str, list[dict[str, Any]]] = {
    "revenue": [
        {
            "code": "REV01",
            "desc": "مقایسه درآمد ثبت شده با بودجه و دوره قبل",
            "assertion": "accuracy",
            "type": "substantive_analytical",
        },
        {
            "code": "REV02",
            "desc": "بررسی نمونه فاکتورهای فروش برای تطبیق با اسناد حمل",
            "assertion": "occurrence",
            "type": "test_of_details",
        },
        {
            "code": "REV03",
            "desc": "بررسی ثبت فروش نزدیک تاریخ ترازنامه (cutoff testing)",
            "assertion": "cutoff",
            "type": "test_of_details",
        },
        ...
        {
            "code": "REV05",
            "desc": "تجزیه و تحلیل نسبت فروش به هزینه و حاشیه سود",
    ...
    "receivables": [
        {
            "code": "AR01",
            "desc": "ارسال صورت حساب به نمونه مشتریان (circularization)",
            "assertion": "existence",
            "type": "test_of_details",
        },
        {
            "code": "AR02",
            "desc": "بررسی سن مطالبات و ذخیره مطالبات مشکوک الوصول",
            "assertion": "valuation",
            "type": "test_of_details",
        },
        {
            "code": "AR03",
            "desc": "بررسی وصول وجه پس از تاریخ ترازنامه",
            "assertion": "valuation",
            "type": "test_of_details",
        },
        {
            "code": "AR04",
            "desc": "تطبیق دفتر معین حساب‌های دریافتنی با کل",
            "assertion": "completeness",
            "type": "substantive_analytical",
        },
    ],
    "inventory": [
        {
            "code": "INV01",
            "desc": "حضور در شمارش فیزیکی موجودی کالا",
            "assertion": "existence",
            "type": "test_of_details",
        },
        {
            "code": "INV02",
            "desc": "بررسی اقلام کُنام (slow-moving) و تاریخ مصرف",
            "assertion": "valuation",
            "type": "test_of_details",
        },
        {
            "code": "INV03",
            "desc": "بررسی مبنای قیمت‌گذاری و محاسبه قیمت تمام شده",
            "assertion": "accuracy",
            "type": "test_of_details",
        },
        {
            "code": "INV04",
            "desc": "تطبیق شمارش فیزیکی با دفاتر",
            "assertion": "completeness",
            "type": "substantive_analytical",
        },
    ],
    "property_plant_equipment": [
        {
            "code": "PPE01",
            "desc": "بررسی افزایش دارایی‌های ثابت و استعلام اسناد مالکیت",
            "assertion": "existence",
            "type": "test_of_details",
        },
        {
            "code": "PPE02",
            "desc": "بررسی عمر مفید و روش استهلاک",
            "assertion": "valuation",
            "type": "substantive_analytical",
        },
        {
            "code": "PPE03",
            "desc": "بررسی واگذاری و کنارگذاری دارایی‌ها",
            "assertion": "completeness",
            "type": "test_of_details",
        },
    ...
    "payables": [
        {
            "code": "AP01",
            "desc": "بررسی ثبت خرید نزدیک تاریخ ترازنامه (cutoff)",
            "assertion": "cutoff",
            "type": "test_of_details",
        },
        {
            "code": "AP02",
            "desc": "بررسی اسناد پرداختنی و تطبیق با صورتحساب",
            "assertion": "completeness",
            "type": "test_of_details",
        },
        ...
        {
            "code": "AP04",
            "desc": "بررسی هزینه‌های تعهدی و ذخایر",
            "assertion": "completeness",
            "type": "substantive_analytical",
        },
    ],
    "cash_and_equivalents": [
        ...
        {
            "code": "CSH02",
            "desc": "بررسی انتقال‌های بانکی نزدیک ترازنامه",
            "assertion": "cutoff",
            "type": "test_of_details",
        },
        ...
        {
            "code": "CSH04",
            "desc": "بررسی محدودیت‌های وجوه نقد",
            "assertion": "rights_obligations",
            "type": "test_of_details",
        },
    ],
    "equity": [
        {
            "code": "EQ01",
            "desc": "بررسی تغییرات در حقوق صاحبان سهام",
            "assertion": "completeness",
            "type": "substantive_analytical",
        },
        {
            "code": "EQ02",
            "desc": "بررسی مصوبات مجمع در خصوص سود و سرمایه",
            "assertion": "occurrence",
            "type": "test_of_details",
        },
...
class ControlTester:
    ...
    def test_cycle_controls(
        ...
        for ctrl in cycle_config["controls"]:
            ...
            sample_size = _attribute_sampling_sample_size(expected_rate, tolerable_rate, self.risk_of_overreliance)
    ...
    def assess_all_cycles(
        ...
        ineffective_count = sum(1 for c in result.cycle_assessments.values() if c.cycle_effectiveness == "ineffective")
        partial_count = sum(
            1 for c in result.cycle_assessments.values() if c.cycle_effectiveness == "partially_effective"
        )
        ...
        for _name, ca in result.cycle_assessments.items():
            for ct in ca.control_tests:
                if ct.severity == "significant_deficiency":
                    result.significant_deficiencies.append(f"{ca.cycle_title}: {ct.control_description}")
