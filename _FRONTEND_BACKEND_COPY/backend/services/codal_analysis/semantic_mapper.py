...
FINANCIAL_EMBEDDINGS_HINT: dict[str, list[str]] = {
    ...
    "OPERATING_CASH_FLOW": [
        ...
        "خالص وجه نقد عملیاتی",
        "خالص جریان نقد عملیاتی",
        "جریان نقد عملیاتی",
        "وجه نقد عملیاتی",
        "خالص وجه نقد حاصل از عملیات",
    ],
    "INVESTING_CASH_FLOW": [
        "وجه نقد حاصل از سرمایه گذاری",
        "خالص وجه نقد سرمایه گذاری",
        "خالص جریان نقد سرمایه گذاری",
    ],
    "FINANCING_CASH_FLOW": [
        "وجه نقد حاصل از تامین مالی",
        "خالص وجه نقد تامین مالی",
    ...
    "NET_FIXED_ASSETS": [
        "اموال و ماشین آلات",
        "دارایی های ثابت خالص",
        "دارایی های ثابت مشهود",
        "خالص اموال و ماشین آلات",
    ],
}
