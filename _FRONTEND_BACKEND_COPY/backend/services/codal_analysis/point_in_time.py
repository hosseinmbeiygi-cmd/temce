...
class PointInTimeEngine:
    ...
    def get_value_at(
        self, symbol: str, fiscal_period: str, account_code: str, as_of_date: str
    ) -> dict[str, Any] | None:
        key = f"{symbol}:{fiscal_period}:{account_code}"
    ...
    def get_restatement_chain(
        self, symbol: str, fiscal_period: str, account_codes: list[str] | None = None
    ) -> RestatementChain:
    ...
    def build_snapshot_at(
        self, symbol: str, fiscal_period: str, as_of_date: str, account_codes: list[str]
    ) -> PointInTimeSnapshot:
