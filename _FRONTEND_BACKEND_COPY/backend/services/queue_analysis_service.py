    ...
    async def _save_result(
        ...
        try:
            ...
            db_row = QueueAnalysisResult(
                ...
                queue_buy_volume=int(result["queue_buy_volume"])
                if result.get("queue_buy_volume") is not None
                else None,
                queue_sell_volume=int(result["queue_sell_volume"])
                if result.get("queue_sell_volume") is not None
                else None,
                # ── Adjusted Scores ──
