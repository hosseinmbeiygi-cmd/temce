...
class FXNewsProvider(NewsProvider):
    """Provider for foreign exchange (FX) market news via API."""

    def __init__(self) -> None:
        super().__init__(name="fx_news")
        self.client = HttpClient(base_url="https://api.example.com/news/foreign/fx")
    ...
    async def fetch_news(
        ...
        **kwargs: Any,
        ...
        return Result.fail(result.error or "Failed to fetch FX news")
    ...
    async def health(self) -> dict[str, Any]:
        return {"healthy": True, "message": "FX news provider ready"}
