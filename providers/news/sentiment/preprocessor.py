...
_PERSIAN_STOPWORDS: set[str] = {
    "و", "در", "به", "از", "که", "این", "را", "با", "بر", "برای",
    "تا", "هم", "نیز", "است", "بود", "شد", "شده", "خود", "آن", "اگر",
    "هر", "چند", "چه", "اما", "یا", "بی", "جز", "زیر", "بیش", "پس",
    "پیش", "بسیار", "همه", "دارد", "ها", "های", "می", "شود", "کرد",
    "یکی", "دو", "سه", "نه", "تنها", "فقط", "البته", "هنوز", "اکنون",
}

_ENGLISH_STOPWORDS: set[str] = {
    "and", "the", "to", "is", "in", "it", "of", "a", "an", "for",
    "on", "with", "as", "at", "by", "or", "be", "this", "that",
    "from", "but", "not", "are", "was", "were", "been", "has", "had",
    "have", "its", "will", "would", "could", "should", "can", "do",
    "does", "did", "so", "if", "than", "then", "no", "about", "up",
}
...
class TextPreprocessor:
    ...
    def remove_stopwords(
        self, tokens: list[str], stopwords: set[str] | None = None
    ) -> list[str]:
