"""pytest-benchmark suite for all 10 MarketService indicators on 50,000 OHLCV bars."""
...
# ── 50,000 OHLCV bars (seeded for reproducibility) ────────
...
def test_bench_sma_14(benchmark) -> None:
...
def test_bench_ema_14(benchmark) -> None:
...
def test_bench_rsi_14(benchmark) -> None:
...
def test_bench_macd_12_26_9(benchmark) -> None:
...
def test_bench_bollinger_20_2(benchmark) -> None:
    benchmark(MarketService._bollinger, prices, 20, 2)


def test_bench_bollinger_50_2(benchmark) -> None:
