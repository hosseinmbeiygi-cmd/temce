...
class TestML:
    ...
    async def test_predict_different_features(self, client):
        for features in [
            {"price_close": 38500, "volume": 1000000},
            {"price_close": 14200},
        ]:
...
class TestEngine:
    ...
    def test_rsi_reversion(self):
        from backtesting.strategies.rule_based.rsi_reversion import (
    ...
    def test_volatility_breakout(self):
        from backtesting.strategies.rule_based.volatility_breakout import (
