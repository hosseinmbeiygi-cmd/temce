...
def is_vpn_active():
    ...
    try:
        ...
        test_sites = [("http://www.google.com", 5), ("http://www.tsetmc.com", 10), ("https://Api.BrsApi.ir", 5)]
...
def check_installations():
    ...
    libs = {"algotik_tse": "algotik-tse", "pytsetmc_api": "pytsetmc-api", "requests": "requests", "pandas": "pandas"}
    installed = {}
...
def test_pytsetmc_api():
    ...
    try:
        ...
        history = client.get_price_history(stock="اهرم", start_date="1403-01-01", end_date="1403-06-01")
...
def test_brsapi():
    ...
    try:
        ...
        params = {"key": os.environ.get("BRSAPI_API_KEY", ""), "type": 0, "l18": "اهرم"}
...
def main():
    ...
    summary = {
        ...
        "results": [],
        "system_info": {"python_version": sys.version, "platform": sys.platform, "working_directory": os.getcwd()},
    }
    ...
    for name, func in tests:
        ...
        # نمایش نتیجه
        status_icon = {"success": "✅", "failed": "❌", "warning": "⚠️", "not_installed": "📦", "skipped": "⏭️"}.get(
    ...
    for r in summary["results"]:
        icon = {"success": "✅", "failed": "❌", "warning": "⚠️", "not_installed": "📦", "skipped": "⏭️"}.get(
